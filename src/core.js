...
const ASSET_EXT={trader_shop:'webp',menu_hangar:'webp',lurker_body:'webp',spore_skimmer:'webp',needle_body:'webp',colony_body:'webp',seeder_body:'webp',warden_body:'webp',matriarch_body:'webp',ground_sentries:'webp',ground_bunkers:'webp',wall_fauna:'png',ground_wrecks:'webp',spore_globule:'png',snap_barb:'png',crawler_body:'webp',battleship_hull:'webp',mech_body:'webp',mothership_body:'webp',world_labyrinth:'webp',world_wilds:'webp',world_foundry:'webp',world_salvage:'webp',world_brood:'webp',world_heart:'webp'};
