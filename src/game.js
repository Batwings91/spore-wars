...
const AUTHORED_WAVES=[
  ...
  [[4,2,0.06],[3,1,0.5],[4,2,0.94],[3,1,0.3]],
  [[4,2,0.06],[3,1,0.65],[4,2,0.94],[3,1,0.35]],
  [[3,1,0.3],[4,2,0.06],[3,1,0.7],[4,2,0.94]],
  [[4,2,0.06],[3,1,0.35],[4,2,0.94],[3,2,0.5]]
];
function spawnFormationGroup(){
  ...
  waveT=formationGroup<groups.length?(level<=4?240:270):(level<=4?120:150);
}
