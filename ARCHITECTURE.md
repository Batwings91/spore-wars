...
Ordinary eligible air kills now drop cores 45% (30% original plus 15% from the empty 0.42..0.57 range); guaranteed weapons and bomb/shield/repair probabilities are unchanged. Each ground destruction adds one physical core pickup and one wreck, guarded by destroyed for exactly-once rewards. Ground wrecks are cosmetic, anchored to worldScroll, capped 20, removed below screen and reset on new run/Continue/quit/checkpoint; boss suppression clears live units but retains wrecks until they scroll away.
