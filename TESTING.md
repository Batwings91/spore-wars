...
Verify 45% core rolls on ordinary eligible air kills; unchanged 2% bombs,6%/2% shields and 4% conditional repairs; guaranteed W still takes precedence. Ground gun/rocket/bomb kills each drop exactly one core and one wreck, including simultaneous hits. Collect/bank new cores at death/checkpoint/quit; Continue never re-banks old earnings. Check wrecks scroll at scenery speed, remain harmless, persist during boss entrance, cap 20 and clear on lifecycle resets. Ground density builds through each stage at 210/180/150/120 ticks with 5/5/5/6 caps and no boss spawns.
